...
export async function deliverWaitlistVerifyEmail(input: { email: string; name?: string | null; verifyLink: string; expiresAt: Date }) {
  ...
  await sendBrandedEmail({
    ...
    to: input.email,
    subject: 'Verify your email for The Hunt',
    preheader: 'Confirm your email and start tracking your fragments in The Hunt.',
    label: 'The Hunt',
    eyebrow: 'Confirm email',
    headline: 'Join The Hunt',
    bodyHtml: [
      `<p style="margin:0 0 16px;">Hi ${name},</p>`,
      '<p style="margin:0 0 18px;">Confirm this email to start your explorer profile and track your fragments as The Hunt unfolds.</p>',
    ...
    footerHtml: 'You received this because this email joined The Hunt.',
    extraPayload: {
