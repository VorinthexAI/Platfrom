...
export const collections: CollectionSpec[] = [
  ...
  { name: 'folders', embedKeys: ['name', 'description'], indexes: [{ fields: ['scopeKey'] }, { fields: ['scopeKey', 'parentFolderKey'] }, { fields: ['scopeKey', 'isFavorite'] }, { fields: ['scopeKey', 'parentFolderKey', 'name'] }, { fields: ['scopeKey', 'purpose'], unique: true, sparse: true }, { fields: ['scopeKey', 'managedPurpose', 'managedOwnerKey', 'name'], unique: true, sparse: true }, { fields: ['scopeKey', 'privateOwnerUserKey', 'parentFolderKey'], sparse: true }] },
  ...
  { name: 'documents', embedKeys: ['name', 'content'], indexes: [{ fields: ['scopeKey'] }, { fields: ['scopeKey', 'folderKey'] }, { fields: ['scopeKey', 'isFavorite'] }, { fields: ['storageKey'], unique: true, sparse: true }, { fields: ['folderKey', 'name'] }, { fields: ['scopeKey', 'managedPurpose', 'managedOwnerKey', 'name'], unique: true, sparse: true }, { fields: ['scopeKey', 'privateOwnerUserKey', 'folderKey'], sparse: true }] },
  ...
  { name: 'conversationMessages', skipEmbedding: true, indexes: [{ fields: ['conversationKey', 'userKey', 'turnKey', 'role'], unique: true }, { fields: ['teamKey', 'scopeKey', 'userKey', 'conversationKey', 'createdAt'] }, { fields: ['conversationKey', 'role', 'status'] }, { fields: ['guideTopics.status', 'guideTopicGeneration'] }] },
  // Durable projection revisions for private, indexed conversation resources in Archive.
  { name: 'conversationArchiveStates', skipEmbedding: true, indexes: [{ fields: ['conversationKey'], unique: true }, { fields: ['projectedRevision', 'desiredRevision', 'updatedAt'] }, { fields: ['teamKey', 'scopeKey', 'userKey'] }] },
