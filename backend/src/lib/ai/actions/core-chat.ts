...
export const CORE_CHAT_MAX_IMAGE_BYTES = 20 * 1024 * 1024;
export const CORE_CHAT_MAX_IMAGE_BYTES_TOTAL = 50 * 1024 * 1024;
export const CORE_CHAT_MAX_FILE_BYTES = 25 * 1024 * 1024;
export const CORE_CHAT_MAX_FILE_BYTES_TOTAL = 50 * 1024 * 1024;
export const CORE_CHAT_MAX_DOCUMENT_CONTEXT_BYTES = 120_000;
...
export const coreChatInputSchema = z.object({
  ...
  if (fileBytes > CORE_CHAT_MAX_FILE_BYTES_TOTAL) context.addIssue({ code: 'custom', path: ['messages'], message: `Chat file bytes must not exceed ${CORE_CHAT_MAX_FILE_BYTES_TOTAL} bytes.` });
});
