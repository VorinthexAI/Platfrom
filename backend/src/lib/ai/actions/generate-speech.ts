...
export const generateSpeechAction: ActionDefinition = { id: 'generate-speech', modelPolicy: 'required', models: [{ provider: 'aws-polly', model: 'amazon.polly-neural', priority: 100 }] };
