...
const toolNames: Record<string, string> = {
  ...
  archive_document_list: 'document.list', archive_document_find: 'document.find', archive_document_create: 'document.create', archive_document_update: 'document.update', archive_document_rename: 'document.rename', archive_document_move: 'document.move', archive_document_copy: 'document.copy', archive_document_summarize: 'document.summarize', archive_document_topics: 'document.topics', archive_document_summaries: 'document.list-summaries', archive_document_summary: 'document.find-summary', archive_document_translate: 'document.translate', archive_document_versions: 'document.list-versions', archive_document_version_restore: 'document.restore-version', archive_document_download: 'document.download',
