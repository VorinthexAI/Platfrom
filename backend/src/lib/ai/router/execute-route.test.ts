...
const decision: RouteDecision = { organizationKey: newId(), actionSlug: 'ask', modelKey: newId(), modelSlug: 'openai.gpt-5.4-nano', providerKey: newId(), orgProviderKey: newId(), providerSlug: 'openai', providerModelId: 'gpt-5.4-nano', credentialSource: 'organization' };
