...
const decision: RouteDecision = { organizationKey: newId(), actionKey: newId(), actionSlug: 'core.ask', modelKey: newId(), modelSlug: 'openai.gpt-5.4-nano', providerKey: newId(), providerSlug: 'openai', providerModelId: 'gpt-5.4-nano' };
