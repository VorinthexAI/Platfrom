...
export const contentToolInputSchemas = {
...
export const contentToolJsonSchemas = {
...
export type ContentActionSlug = keyof typeof contentToolInputSchemas;
export const isContentAction = (action: string): action is ContentActionSlug => action in contentToolInputSchemas;
