...
async function inheritedGrantPlan(context: ToolContext, relation: ScopeAgentRecord) {
...
async function applyInheritedGrantPlan(context: ToolContext, relation: ScopeAgentRecord) {
...
export async function syncOrganizationAgentMembers(context: ToolContext) {
