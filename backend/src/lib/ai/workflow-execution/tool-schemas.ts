...
export const workflowExecutionToolInputSchemas = {
...
export const workflowExecutionToolJsonSchemas = jsonSchemas as { [K in keyof typeof workflowExecutionToolInputSchemas]: Record<string, unknown> };
export type WorkflowExecutionActionSlug = keyof typeof workflowExecutionToolInputSchemas;
export const isWorkflowExecutionAction = (action: string): action is WorkflowExecutionActionSlug => action in workflowExecutionToolInputSchemas;
