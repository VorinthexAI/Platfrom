...
describe('book repository generation leases', () => {
  ...
  test('blocks cancelled retries until the active lease expires', async () => {
    ...
    const generationInput = { topic: 'Thinking', goal: 'Decide well', currentKnowledge: 'Basics', writingTone: 'Clear', chapterCount: 10, language: 'English', archiveDocumentKeys: [], narratorVoiceKey: 'clear', narrationPace: 1, chapterImages: false };
