...
export const legacyEmailArchiveRootFolderKey = (scopeKey: string) => stableKey('email-archive-export-root', scopeKey);
export const emailArchiveRootFolderKey = (scopeKey: string) => initialWorkspaceFolderKey(scopeKey, 'communication');
