...
describe('inbox schema', () => {
  test('keeps the canonical one-to-one metadata and exact semantic field order', () => {
    ...
    const inbox = inboxSchema.parse({ key: newId(), teamKey: 'team', scopeKey: newId(), connectorKey: newId(), name: 'Work', description: 'Primary mail', isFavorite: false, embedding: Array(EMBEDDING_DIMENSIONS).fill(0), createdAt: '2026-08-23T00:00:00.000Z', updatedAt: '2026-08-23T00:00:00.000Z' });
