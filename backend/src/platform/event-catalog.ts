...
export const serverEventSlugs = [
  ...
  'chorus.message.create', 'chorus.message.update', 'chorus.message.remove',
  'artifact.create',
  ...
  'organization.provider.list', 'organization.provider.read', 'organization.provider.create',
  'organization.provider.update', 'organization.provider.usage', 'organization.provider.enable',
