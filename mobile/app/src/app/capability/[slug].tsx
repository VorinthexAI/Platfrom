...
export default function CapabilityRoute() {
  ...
  if (parsed.data === "archive") return <KnowledgeWorkspace initialCollectionKind={params.collectionKind} initialDocumentKey={params.documentKey} initialFolderKey={params.assetKey} initialSearchQuery={params.initialQuery} returnSignalConnectorKey={params.returnSignalConnectorKey} returnSignalMessageKey={params.returnSignalMessageKey} returnSignalThreadKey={params.returnSignalThreadKey} returnTripKey={params.returnTripKey} returnTripName={params.returnTripName} />;
  ...
  if (parsed.data === "compass") return <TravelWorkspace initialCollectionKind={params.collectionKind} initialCountryCode={params.countryCode} initialPlaceKey={params.placeKey} initialSearchQuery={params.initialQuery} initialTripKey={params.tripKey} openTripAssets={params.openTripAssets === "1"} />;
  ...
  return <AscendWorkspace initialBookKey={params.bookKey} initialSearchQuery={params.initialQuery} />;
}
