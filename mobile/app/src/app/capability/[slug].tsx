...
export default function CapabilityRoute() {
  const params = useLocalSearchParams<{ slug: string; assetKey?: string; returnTripKey?: string; returnTripName?: string; tripKey?: string; openTripAssets?: string }>();
  ...
  if (parsed.data === "archive") return <KnowledgeWorkspace initialFolderKey={params.assetKey} returnTripKey={params.returnTripKey} returnTripName={params.returnTripName} />;
