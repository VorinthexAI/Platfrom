...
export default function CapabilityRoute() {
  const params = useLocalSearchParams<{ slug: string; assetKey?: string; documentKey?: string; returnTripKey?: string; returnTripName?: string; tripKey?: string; openTripAssets?: string }>();
