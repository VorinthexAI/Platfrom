...
const styles = StyleSheet.create({
  ...
  detailImageFrame: { flex: 1, width: "100%", overflow: "hidden", borderRadius: radii.md, backgroundColor: palette.voidBlack },
  detailImage: { width: "100%", height: "100%", borderRadius: radii.md },
