  ...
  async function refreshActiveView() {
    ...
    try {
      if (selectedPlace) {
        ...
        await (semanticSearchActive ? savedPlaceSearchQuery.refetch() : overviewQuery.refetch());
      } else {
        await (semanticSearchActive ? tripSearchQuery.refetch() : tripsQuery.refetch());
      }
    } finally {
