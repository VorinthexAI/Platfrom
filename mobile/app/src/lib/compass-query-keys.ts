...
export const compassQueryKeys = {
  ...
  placeSearch: (context: WorkspaceContext, query: string) => [...compassQueryKeys.placeSearches(context), query.trim().toLocaleLowerCase()] as const,
  tripSearches: (context: WorkspaceContext) => [...compassQueryKeys.all(context), "trip-searches"] as const,
  tripSearch: (context: WorkspaceContext, query: string) => [...compassQueryKeys.tripSearches(context), query.trim().toLocaleLowerCase()] as const,
