  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Storage charges are deducted from prepaid Sparks hourly. If the available balance cannot cover storage, no debt or grace-period backcharges accrue and uploads can continue. Existing data remains available for export, deletion, and recovery. Adding enough Sparks before deletion begins restores prospective storage charging. If storage remains unfunded for 90 consecutive days, stored data is permanently deleted, and adding Sparks after deletion begins cannot reverse that process.",
      ],
    },
    {
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "Stored data is permanently deleted after storage remains unfunded for 90 consecutive days.",
      ],
    },
  ],
