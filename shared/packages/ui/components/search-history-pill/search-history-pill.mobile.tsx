...
const styles = StyleSheet.create({
  root: { width: "100%", height: 38, padding: 2, flexDirection: "row", alignItems: "center", borderRadius: 999, borderColor: "rgba(221, 226, 229, 0.14)", borderWidth: 1, backgroundColor: colors.page },
  ...
  badge: { minWidth: 28, height: 22, flexShrink: 0, paddingHorizontal: 7, alignItems: "center", justifyContent: "center", borderColor: "rgba(221, 226, 229, 0.14)", borderWidth: 1, borderRadius: 999, backgroundColor: colors.page },
