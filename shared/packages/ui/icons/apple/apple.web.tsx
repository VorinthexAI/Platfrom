...
export type AppleIconProps = Omit<SVGProps<SVGSVGElement>, "color"> & { color?: string; size?: number };

export function AppleIcon({ color = "currentColor", size = 20, ...props }: AppleIconProps) {
  return (
