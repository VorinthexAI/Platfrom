...
export type ChevronRightIconVariant = "default" | "muted" | "accent" | "danger" | "inverse";
...
export function ChevronRightIcon({ variant = "default", size = "md", strokeWidth = 1.4, ...props }: ChevronRightIconProps) {
