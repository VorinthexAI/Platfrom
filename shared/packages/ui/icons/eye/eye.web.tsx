...
export type EyeIconVariant = "default" | "inherit" | "muted" | "accent" | "danger" | "inverse";
...
export function EyeIcon({ variant = "inherit", size = "md", strokeWidth = 1.4, ...props }: EyeIconProps) {
