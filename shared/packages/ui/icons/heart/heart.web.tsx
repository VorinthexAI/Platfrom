...
export type HeartIconVariant = "default" | "inherit" | "muted" | "accent" | "danger" | "inverse";
...
export function HeartIcon({ variant = "inherit", size = "md", strokeWidth = 1.4, ...props }: HeartIconProps) {
