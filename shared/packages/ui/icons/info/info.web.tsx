...
export type InfoIconVariant = "default" | "inherit" | "muted" | "accent" | "danger" | "inverse";
export type InfoIconSize = "sm" | "md" | "lg";
export type InfoIconProps = Omit<SVGProps<SVGSVGElement>, "color"> & {
...
export function InfoIcon({ variant = "inherit", size = "md", strokeWidth = 1.4, ...props }: InfoIconProps) {
