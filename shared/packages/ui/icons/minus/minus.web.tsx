...
export type MinusIconVariant = "default" | "inherit" | "muted" | "accent" | "danger" | "inverse";
...
export function MinusIcon({ variant = "inherit", size = "md", strokeWidth = 1.4, ...props }: MinusIconProps) {
