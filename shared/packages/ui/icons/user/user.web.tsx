...
export type UserIconVariant = "default" | "inherit" | "muted" | "accent" | "danger" | "inverse";
...
export function UserIcon({ variant = "inherit", size = "md", strokeWidth = 1.4, ...props }: UserIconProps) {
