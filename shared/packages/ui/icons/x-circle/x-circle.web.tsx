...
export type XCircleIconVariant = "default" | "inherit" | "muted" | "accent" | "danger" | "inverse";
...
export function XCircleIcon({ variant = "inherit", size = "md", strokeWidth = 1.4, ...props }: XCircleIconProps) {
