 ...
 * validate claims against this same config, the client is never trusted.
 */
const collectibles: CollectibleDef[] = [
  { id: "collectible.frag-belt-1", slug: "frag-belt-1", name: "Belt Fragment", type: "fragment", rarity: "common", fragments: 12, isLive: true, isClaimable: true, isDiscoverable: true, position: [8.6, 0.4, -2.8], parentEntityId: "nexus.star" },
  { id: "collectible.frag-belt-2", slug: "frag-belt-2", name: "Belt Fragment", type: "fragment", rarity: "common", fragments: 16, isLive: true, isClaimable: true, isDiscoverable: true, position: [-9.1, -0.6, 3.4], parentEntityId: "nexus.star" },
  { id: "collectible.frag-core-echo", slug: "frag-core-echo", name: "Core Echo", type: "material", rarity: "uncommon", fragments: 32, isLive: true, isClaimable: true, isDiscoverable: true, position: [4.6, 1.5, 4.4], parentEntityId: "product.core" },
  { id: "collectible.frag-command-cipher", slug: "frag-command-cipher", name: "Command Cipher", type: "blueprint", rarity: "rare", fragments: 96, isLive: true, isClaimable: true, isDiscoverable: true, position: [-6.2, 1.8, -5.6], parentEntityId: "product.command" },
  { id: "collectible.founder-relic", slug: "founder-relic", name: "Founder Relic", type: "relic", rarity: "founder", fragments: 1000, isLive: true, isClaimable: true, isDiscoverable: true, position: [12.5, -2.2, 9.8], parentEntityId: "product.launch" },
  { id: "collectible.frag-nexus-mote", slug: "frag-nexus-mote", name: "Nexus Mote", type: "fragment", rarity: "common", fragments: 8, isLive: true, isClaimable: true, isDiscoverable: true, position: [2.2, 1.9, -3.1], parentEntityId: "nexus.star" },
  { id: "collectible.frag-studio-prism", slug: "frag-studio-prism", name: "Studio Prism", type: "material", rarity: "uncommon", fragments: 40, isLive: true, isClaimable: true, isDiscoverable: true, position: [-3.4, -1.4, 9.6], parentEntityId: "product.studio" },
  { id: "collectible.frag-launch-spark", slug: "frag-launch-spark", name: "Launch Spark", type: "fragment", rarity: "common", fragments: 14, isLive: true, isClaimable: true, isDiscoverable: true, position: [11.4, 0.9, -6.8], parentEntityId: "product.launch" },
  { id: "collectible.frag-outer-sigil", slug: "frag-outer-sigil", name: "Outer Sigil", type: "blueprint", rarity: "rare", fragments: 120, isLive: true, isClaimable: true, isDiscoverable: true, position: [-14.6, 1.2, -9.4], parentEntityId: "nexus.star" },
  { id: "collectible.frag-belt-vein", slug: "frag-belt-vein", name: "Belt Vein", type: "material", rarity: "uncommon", fragments: 48, isLive: true, isClaimable: true, isDiscoverable: true, position: [16.8, -0.8, 4.2], parentEntityId: "nexus.star" },
  { id: "collectible.frag-drift-tear", slug: "frag-drift-tear", name: "Drift Tear", type: "fragment", rarity: "rare", fragments: 88, isLive: true, isClaimable: true, isDiscoverable: true, position: [0.4, -2.6, -12.8], parentEntityId: "nexus.star" },
  { id: "collectible.frag-halo-seed", slug: "frag-halo-seed", name: "Halo Seed", type: "fragment", rarity: "common", fragments: 10, isLive: true, isClaimable: true, isDiscoverable: true, position: [-7.8, 2.4, 8.9], parentEntityId: "product.studio" },
  ...
  { id: "collectible.geode-core-1", slug: "geode-core-1", name: "Core Geode", type: "material", rarity: "uncommon", fragments: 24, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.core" },
  { id: "collectible.geode-core-2", slug: "geode-core-2", name: "Memory Vein", type: "material", rarity: "rare", fragments: 64, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.core" },
  { id: "collectible.geode-command-1", slug: "geode-command-1", name: "Command Geode", type: "material", rarity: "uncommon", fragments: 28, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.command" },
  { id: "collectible.geode-command-2", slug: "geode-command-2", name: "Strategy Vein", type: "material", rarity: "rare", fragments: 72, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.command" },
  { id: "collectible.geode-studio-1", slug: "geode-studio-1", name: "Studio Geode", type: "material", rarity: "uncommon", fragments: 26, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.studio" },
  { id: "collectible.geode-studio-2", slug: "geode-studio-2", name: "Prism Vein", type: "material", rarity: "rare", fragments: 68, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.studio" },
  { id: "collectible.geode-launch-1", slug: "geode-launch-1", name: "Launch Geode", type: "material", rarity: "uncommon", fragments: 30, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.launch" },
  { id: "collectible.geode-launch-2", slug: "geode-launch-2", name: "Ember Vein", type: "material", rarity: "rare", fragments: 76, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.launch" },
  { id: "collectible.geode-core-3", slug: "geode-core-3", name: "Thought Shard", type: "fragment", rarity: "common", fragments: 12, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.core" },
  { id: "collectible.geode-core-4", slug: "geode-core-4", name: "Grove Pearl", type: "material", rarity: "uncommon", fragments: 34, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.core" },
  { id: "collectible.geode-command-3", slug: "geode-command-3", name: "Order Shard", type: "fragment", rarity: "common", fragments: 14, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.command" },
  { id: "collectible.geode-command-4", slug: "geode-command-4", name: "Vault Pearl", type: "material", rarity: "uncommon", fragments: 36, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.command" },
  { id: "collectible.geode-studio-3", slug: "geode-studio-3", name: "Muse Shard", type: "fragment", rarity: "common", fragments: 12, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.studio" },
  { id: "collectible.geode-studio-4", slug: "geode-studio-4", name: "Spore Pearl", type: "material", rarity: "uncommon", fragments: 32, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.studio" },
  { id: "collectible.geode-launch-3", slug: "geode-launch-3", name: "Ignition Shard", type: "fragment", rarity: "common", fragments: 16, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.launch" },
  { id: "collectible.geode-launch-4", slug: "geode-launch-4", name: "Magma Pearl", type: "material", rarity: "uncommon", fragments: 38, isLive: true, isClaimable: true, isDiscoverable: false, position: [0, 0, 0], parentEntityId: "product.launch" },
];
